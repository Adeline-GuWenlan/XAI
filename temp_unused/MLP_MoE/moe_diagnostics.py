...
def main():
    ...
    ap.add_argument("--checkpoint", type=str, default="CONFIGs/2_128_cls_moe_20250817_202509/best_2_128_cls_moe_20250817_202509.pth", help="Path to model checkpoint (.pt)")
