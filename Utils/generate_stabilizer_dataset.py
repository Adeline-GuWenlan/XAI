...
def generate_dataset(num_samples, qubits, output_path=None, seed=None):
    """
    ...
    print(f"Generating {num_samples} samples for {qubits} qubits (dimension {dimension}x{dimension})")
    ...
    for i in range(num_samples):
        ...
        rho = random_mixed_state(dimension)
        """        
...
def main():
    ...
    # Generate dataset
    states, labels = generate_dataset(args.num, args.qubits, args.output, args.seed)
